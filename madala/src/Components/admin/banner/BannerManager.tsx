...
function BannerManager() {
    ...
    // Memoize fetch banners function
    ...
    // Memoize update banner counts function
    const updateBannerCounts = useCallback((bannerData: IBanner[]) => {
        const counts = {
    ...
    // Memoize active stats calculation
    ...
    // Memoize filter banners function
    const filterBanners = useCallback((bannerData: IBanner[], type: string) => {
        if (type === 'all') {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div className="text-2xl font-bold text-blue-900 mt-1">
                                {activeStats.activeSale}/{activeStats.totalSale}
                            </div>
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            ...
                            <div className="text-2xl font-bold text-green-900 mt-1">
                                {activeStats.activeAdvertisement}/{activeStats.totalAdvertisement}
                            </div>
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            ...
                            <div className="text-2xl font-bold text-gray-900 mt-1">
                                {activeStats.totalActive}/{activeStats.totalBanners}
                            </div>
