        ...
        try {
            ...
            if (selectedFiles.length > 0) {
                try {
                    ...
                    toast.error(`Lỗi upload file: ${error instanceof Error ? error.message : 'Unknown error'}. Đánh giá sẽ được gửi không có ảnh/video`);
                }
            }
                    ...
                    <div className="mb-6">
                        ...
                        {selectedFiles.length > 0 && (
                            <div className="mt-3 space-y-2">
                                <h5 className="text-sm font-medium text-gray-700">File đã chọn:</h5>
